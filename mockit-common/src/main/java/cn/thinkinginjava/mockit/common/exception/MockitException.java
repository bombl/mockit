...
public class MockitException extends RuntimeException {
     ...
     * @param e the e
     */
    public MockitException(final Throwable e) {
        super(e);
    }
     ...
     */
    public MockitException(final String message) {
        super(message);
    }
     ...
     */
    public MockitException(final String message, final Throwable throwable) {
